...
// Instance
// Instantiating -> It calls the contructor!
...
// title
// constructor
// read() -> You are currently reading TITLE by AUTHOR
...
const geb = new Book("GEB", "Little Dougie"); // Run the constructor for me
geb.read();
...
class Admin extends User {
  constructor(name, username) {
    super(); // This calls User constructor
    this.admin = true;
